...
const Tauros: Pokemon = {
  ...
  formes: [
    ...
    {
      name: 'Tauros',
      formeName: 'Tauros-Paldea-Combat',
      formeNumber: 1,
      isBaseForme: false,
      isMega: false,
      isGMax: false,
      isBattleOnly: false,
      alias: 'taurospaldeacombat',
      types: ['Fighting'],
      genderRatio: { male: 1, female: 0 },
    ...
    {
      name: 'Tauros',
      formeName: 'Tauros-Paldea-Blaze',
      formeNumber: 2,
      isBaseForme: false,
      isMega: false,
      isGMax: false,
      isBattleOnly: false,
      alias: 'taurospaldeablaze',
      types: ['Fighting', 'Fire'],
      genderRatio: { male: 1, female: 0 },
      baseStats: { hp: 75, atk: 110, def: 105, spa: 30, spd: 70, spe: 100 },
      ability1: 'Intimidate',
    ...
    {
      name: 'Tauros',
      formeName: 'Tauros-Paldea-Aqua',
      formeNumber: 3,
      isBaseForme: false,
      isMega: false,
      isGMax: false,
      isBattleOnly: false,
      alias: 'taurospaldeaaqua',
